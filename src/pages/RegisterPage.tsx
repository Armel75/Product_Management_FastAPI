...
import { UserPlus, Lock, Mail, AlertCircle, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8 relative">
          ...
          <p className="text-slate-400 text-sm mt-1">Get started with standard secure credentials</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-slate-300 text-sm font-medium mb-1.5" htmlFor="root-register-email">
              Email Address
            </label>
          ...
          <div>
            <label className="block text-slate-300 text-sm font-medium mb-1.5" htmlFor="root-register-password">
              Password
            </label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-slate-500">
          ...
          <div>
            <label className="block text-slate-300 text-sm font-medium mb-1.5" htmlFor="root-register-confirm">
              Confirm Password
            </label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-slate-500">
